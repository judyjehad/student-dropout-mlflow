...
### Confusion matrices (model fusion)

Generated by `fusion_model.py` and saved to `outputs/` and `docs/screenshots/`.

| Soft Voting (LR + RF + XGB) | Stacking (LR meta-learner) |
|-----------------------------|----------------------------|
| ![Voting confusion matrix](docs/screenshots/confusion_matrix_voting_soft.png) | ![Stacking confusion matrix](docs/screenshots/confusion_matrix_stacking_logreg.png) |

### Statistical significance (McNemar's test)

Generated by `mcnemar_test.py` — the agreement/disagreement contingency table for the soft VotingClassifier vs the production Random Forest, with the McNemar exact p-value (p = 0.7436 → not significant).

![McNemar's test](docs/screenshots/mcnemar_test.png)
